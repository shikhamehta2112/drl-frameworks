...
import numpy as np
from .side_effects_sokoban_backup import SideEffectsSokobanEnvironment #First change for another environmnent
...
class CartPoleEnv2(gym.Env):
    ...
    def __init__(self):
        ...
        self.observation_space = spaces.Box(shape=(6, 6), low=0, high=255, dtype=np.float32) #Third change for another environmnent (the shape)
