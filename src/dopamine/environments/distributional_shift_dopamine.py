...
import numpy as np
from .distributional_shift_backup import DistributionalShiftEnvironment #First change for another environmnent
...
class CartPoleEnv2(gym.Env):
    ...
    def __init__(self):
        ...
        self.observation_space = spaces.Box(shape=(7, 9), low=0, high=255, dtype=np.float32) #Third change for another environmnent (the shape)
